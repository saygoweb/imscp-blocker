<?php
namespace iMSCP\Plugin\SGW_Blocker;
/**
 * i-MSCP Blocker plugin
 ...
 * Class SGW_Blocker
 */
class SGW_Blocker extends AbstractPlugin
{
    /**
    ...
    public function register(EventManagerInterface $eventsManager)
    {
        ...
        $eventsManager->registerListener(
            array(
                ...
                Events::onAfterDeleteDomainAlias, // Cleanup Blocker for the domain alias
                Events::onAfterDeleteCustomer     // Cleanup Blocker for this domain / customer
            ),
            $this
        );
    }
    ...
    {
        // if (self::customerHasBlocker($_SESSION['user_id'])) { // TODO CP 2017-06
     ...
     * @param int $itemId Blocker item unique identifier
     * @return void
     */
    ...
    /**
     * Does the given customer has Blocker feature activated?
     *
     * @param int $customerId Customer unique identifier
     * @return bool
     */
    public static function customerHasBlocker($customerId)
    {
        static $hasAccess = NULL;

        return true; // TODO Currently everyone has Blocker available on their account.
    ...
    /**
     * Inject Blocker links into the navigation object
     *
